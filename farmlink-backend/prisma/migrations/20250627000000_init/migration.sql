...
-- CreateEnum
CREATE TYPE "MatchStatus" AS ENUM ('RECOMMENDED', 'VIEWED', 'DISMISSED', 'OFFERED', 'CONVERTED', 'EXPIRED');
...
CREATE TABLE "BuyerProfile" (
    ...
    "maximumTravelDistanceKm" INTEGER NOT NULL DEFAULT 100,
    "verificationStatus" "VerificationStatus" NOT NULL DEFAULT 'UNVERIFIED',
    "createdAt" TIMESTAMP(3) NOT NULL DEFAULT CURRENT_TIMESTAMP,
    "updatedAt" TIMESTAMP(3) NOT NULL,
...
-- CreateIndex
CREATE INDEX "MatchRecommendation_buyerId_idx" ON "MatchRecommendation"("buyerId");

-- CreateIndex
CREATE INDEX "MatchRecommendation_listingId_idx" ON "MatchRecommendation"("listingId");

-- CreateIndex
CREATE INDEX "MatchRecommendation_status_idx" ON "MatchRecommendation"("status");
...
-- CreateIndex
CREATE INDEX "ProduceTransaction_listingId_idx" ON "ProduceTransaction"("listingId");
