...
import { buyerProfileApi, isApiError, ratingsApi } from '@/lib/api';
    ...
    <div className="mx-auto max-w-3xl space-y-6 px-4 py-5 pb-8 lg:px-8">
      ...
      {ratingsQuery.data && (
        <RatingSummaryCard
          ...
          title="Your buyer rating"
          emptyMessage="No farmer ratings yet. Complete a purchase to receive your first review."
          className="border-soft-border bg-warm-paper dark:bg-deep-grove/20"
        />
      )}
    </div>
  );
